              ...
              <div class="carousel-content container">
                ...
                <p>
                   <?php
                      ...
                      $query = "SELECT A.price,A.reg_no,C.model,C.color,C.hasCarrier,C.location_name,C.cycle_condition,B.first_name,B.last_name,B.email_id,B.username,A.request_date,C.rating from pending_buy_cycle_requests A, user_ B, cycle C where A.reg_no = C.reg_no and C.username = B.username and A.buyer = '$username';";
                      $result = mysqli_query($con, $query);
                      $numResults = mysqli_num_rows($result);
                      if($numResults==0){
                        echo "<h2> Pending Buy Requests</h2> ";
                      ...
                      echo "<h5> <font color='white'> View Completed Requests <a href = 'view_completed_buy_requests.php'> Here</a> </font></h5>";
                      echo "<h5> <font color='white'> Go to <a href = 'buy_cycle.php'> Buy Cycle </a> </font></h5>";
                      echo "<h5> <font color='white'> Use the delete button to delete pending requests. <br> </font> </h5> ";
                      echo "<table>\n";
                      echo "<thead> <tr class='table100-head'>
                            ...
                            <td class='column11'>Request Date </td>
                            <td class='column12'>Delete</td>
                            </tr> </thead> \n";
                      ...
                      while ($row = mysqli_fetch_assoc($result)){
                        ...
                        echo "<tr>
                            ...
                            <td class='column11'>".$row["request_date"]."</td>
                            <td class='column12'><a title='Delete Request' href='forms/delete_request.php?reg_no=".$row['reg_no']."'><i class='icofont-ui-delete' style='color: rgb(255,0,0)'></i></a></td>
                            </tr>\n";
