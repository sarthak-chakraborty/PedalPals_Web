              ...
              <div class="carousel-content container">
                <p>
                   <?php
                      ...
                      echo "<h4><font color='white'> View Cycles Given for Rent Transaction History <a href='transaction_details_owner.php'> Here </a></font></h4>";
                        exit();
                      }
                      ...
                      while ($row = mysqli_fetch_assoc($result)){
                        ...
                        if($current_date < $end_date || $rating!=null){
                         ...
                         echo "<tr>
                            ...
                            <td class='column6'>".$total."</td>
                            <td class='column7'>".$reward."</td>
                            <form action='forms/rate_cycle.php?transaction_id=".$row["transaction_id"]."' method='post' role='form'>
