              ...
              <div class="carousel-content container">
                <p>
                    <?php
                      ...
                      if($numResults==0){
                        echo "<h4><font color='white'>No queries available</font></h4>";
                        exit();
                      }
                      ...
                      echo "<thead> <tr class='table100-head'>
                            ...
                            <td class='column4'>Name</td>
                            <td class='column5'>Subject</td>
                            <td class='column6'></td>
                            </tr> </thead> \n";
                      ...
                      while ($row = mysqli_fetch_assoc($result)){
                        echo "<tr>
                            <td class='column1'><a title='Details' href='queries_expanded.php?name=".$row['name']."&email=".$row['email_id']."&subject=".$row['subject']."'><i class='icofont-eye'></i></a></td>
                            <td class='column2'>".$id."</td>
                            <td class='column3'>".$row["qdate"]."</td>
                            <td class='column4'>".$row["name"]."</td>
                            <td class='column5'>".$row["subject"]."</td>
                            <td class='column6'><a title='Delete Queries' href='forms/remove_queries.php?name=".$row['name']."&email=".$row['email_id']."&subject=".$row['subject']."'><i class='icofont-ui-delete' style='color: rgb(255,0,0)'></i></a></td>
                            </tr>\n";
