...
<head>
  ...
  <title>View Completed Sell Requests</title>
              ...
              <div class="carousel-content container">
                ...
                <p>
                   <?php
                      ...
                      $query = "SELECT A.reg_no,model,color,A.price,first_name,last_name,email_id,A.buyer,A.seller,request_date,completion_date,status from completed_buy_cycle_requests A, user_ B, cycle C where A.reg_no = C.reg_no and A.seller = '$username' and A.buyer = B.username;";
                      $result = mysqli_query($con, $query);
                      $numResults = mysqli_num_rows($result);
                      if($numResults==0){
                        echo "<h2> Accepted/Rejected Requests</h2> ";
                        echo "<h5><font color='white'> No records available </font></h5>";
                       echo "<h5> <font color='white'> Go to <a href = 'sell_cycle.php'> Sell Cycle </a> </font></h5>";
                        exit();
                      }
                      ...
                      while ($row = mysqli_fetch_assoc($result)){
                        ...
                        $query2 = "select * from mobilenumber where username='".$row["buyer"]."';";
